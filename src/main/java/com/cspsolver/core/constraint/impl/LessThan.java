 ...
 */
public class LessThan<T extends Comparable<T>> extends BinaryConstraint<T> {

    public LessThan(Variable<T> var1, Variable<T> var2) {
        super(var1, var2);
    }

    public LessThan(Variable<T> var1, Variable<T> var2, String name) {
